...
public class MenuPause : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (isPaused)
        {
            ...
            if (GUI.Button(new Rect(Screen.width / 2 - 40, Screen.height / 2 - 20, 180, 40), "Continuer"))
            {
                isPaused = false;
            }
            ...
            if (GUI.Button(new Rect(Screen.width / 2 - 40, Screen.height / 2 + 100, 180, 40), "Retourner au Bureau"))
            {
                Application.Quit(); 
            }

            if (GUI.Button(new Rect(Screen.width / 2 - 40, Screen.height / 2 + 40, 180, 40), "Menu"))
            {
